...
.PHONY: install
install: package lint ## Install chart for dev test
...
.PHONY: check
check: ## Check installed chart
	helm list -A
	kubectl get deploy,po -n clusternet-system

.PHONY: uninstall
uninstall: ## Uninstall chart for dev test
